...
rootDev=`blkid | awk '$2 == "LABEL=\"rootfs\"" {print $1}' | sed 's/.$//'`
#rootPARTUUID=`awk '$2 == "/" {print $1}' /etc/fstab`
rootPARTUUID=`blkid | awk '$2 == "LABEL=\"rootfs\"" {print $5}' | sed 's/PARTUUID=\"//' | sed 's/.$//'`
rootMountOpt=`awk '$2 == "/" {print $4}' /etc/fstab`
rootFsType=`awk '$2 == "/" {print $3}' /etc/fstab`
dataDev=`blkid | awk '$2 == "LABEL=\"data\"" {print $1}' | sed 's/.$//'`
dataMnt=/mnt/rw/save
